...
# Plot the Ricci focusing term to see the pure density/lensing effect
pRkk = plot(z_eval, Rkk.(λ_), 
    xlabel=L"z", 
    ylabel=L"R_{\mu\nu} k^\mu k^\nu",
    title="Gravitational Focusing (Ricci Convergence)", 
    grid=true, 
    label="LTB Matter Focusing",
    color=:red)
